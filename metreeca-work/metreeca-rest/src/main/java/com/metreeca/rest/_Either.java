 ...
 */
@FunctionalInterface public interface _Either<L, R> {
     ...
     */
    public static <V> _Either<RuntimeException, V> from(final Supplier<V> supplier) {
     ...
     */
    public default <V> _Either<L, V> map(final Function<R, V> mapper) {
     ...
     * @throws NullPointerException if {@code mapper} is null or returns a null value
     */
    public default <V> _Either<L, V> flatMap(final Function<R, _Either<L, V>> mapper) {
