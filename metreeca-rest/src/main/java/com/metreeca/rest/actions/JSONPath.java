...
public final class JSONPath<R> implements Function<JsonValue, R> {
    ...
    public static final class Processor {
         ...
         * @param path the JSONPath expression to be evaluated against the target value
         *
         * @return an optional JSON array produced by evaluating {@code path} against the target value, if one was
         * available; an empty optional, otherwise
         *
         * @throws NullPointerException if {@code path} is null
         */
        ...
        public Xtream<JsonArray> arrays(final String path) {
            ...
            return values(path)
                    .filter(value -> value.getValueType() == ValueType.ARRAY)
         ...
         * @throws NullPointerException if {@code path} is null
         */
        public Optional<Processor> path(final String path) {
         ...
         * @param path the JSONPath expression to be evaluated against the target value
         *
         * @return a stream of JSONPath processors targeting values generated by evaluating {@code path} against the
         * target value
         *
         * @throws NullPointerException if {@code path} is null
         */
        public Xtream<Processor> paths(final String path) {

            if ( path == null ) {
                throw new NullPointerException("null JSONPath expression");
            }

            return values(path).map(Processor::new);
        }
