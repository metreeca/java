...
final class MultipartParser {
    ...
    @FunctionalInterface private static interface State {
        ...
        public State next(final Type type) throws CodecException;
    ...
    void parse() throws IOException, CodecException {
    ...
    private State preamble(final Type type) throws CodecException {
    ...
    private State part(final Type type) throws CodecException {
    ...
    private State body(final Type type) throws CodecException {
    ...
    private State header(final State next) throws CodecException {
        try {
     ...
     */
    private Type read() throws IOException, CodecException {
