...
public final class Response extends Message<Response> {
     ...
     *
     * @return the absolute IRI included in the {@code Location} header of this response, if defined; the
     * {@linkplain Request#item() focus item} IRI of the originating request otherwise
     */
