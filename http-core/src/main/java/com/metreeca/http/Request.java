...
public final class Request extends Message<Request> {
     ...
     *
     * @return {@code true} if the {@linkplain #method() method} of this request is {@link #safe() safe}, its
     * {@link #path() path} doesn't contain a filename extension (e.g. {@code .html}) and its {@code Accept} header
     * includes a MIME type usually associated with an interactive browser-managed HTTP request (e.g. {@code text/html};
     ...
     *
     * @return {@code true} if the {@linkplain #method() method} of this request is {@link #safe() safe} and its
     * {@link #path() path} contains a filename extension (e.g. {@code .html}); {@code false}, otherwise
     */
     ...
     *
     * @return {@code true} if this request is performed by a {@linkplain #user() user} in one of the given
     * {@code roles}, that is if {@code roles} and  {@linkplain #roles() request roles} are not disjoint
     */
     ...
     *
     * @param roles a collection of values uniquely identifying the roles assigned to the request
     *              {@linkplain #user() user}
     *
     * @return this request
     *
     ...
     * Configures the roles attributed to the request user.
     *
     * @param roles a collection of IRIs uniquely identifying the roles assigned to the request
     *              {@linkplain #user() user}
     *
     * @return this request
     *
