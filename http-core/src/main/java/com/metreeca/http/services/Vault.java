...
@FunctionalInterface public interface Vault {
     ...
     *
     * @return the default vault factory, which retrieves parameters either from
     * {@linkplain System#getProperties() system properties} or {@linkplain System#getenv() environment variables}, in
     * that order
     */
