...
import static com.metreeca.http.toolkits.Feeds.text;
...
public final class Text implements Format<String> {
     ...
     * already defined, and its raw {@linkplain Message#output(Consumer) output} configured to return the textual
     * {@code value} taking into account the {@code message} {@linkplain Message#charset() charset}
     */
