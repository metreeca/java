...
public final class Bean<T> implements Codec<T> {
    ...
    /**
     * <p><strong>Warning</strong> / Decoding is completely driven by the codec {@linkplain #type() type}: embedded
     * {@code @context} objects are ignored.</p>
     *
     ...
     */
    @Override public Optional<T> decode(final Message<?> message) throws CodecException {
        return message
     ...
     * {@code value}
     */
    @Override public <M extends Message<M>> M encode(final M message, final T value) throws CodecException {
