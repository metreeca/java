...
package com.metreeca.http.rdf.schemas;
...
public final class Schema {
     ...
     *
     * @return a normalized {@code model} where legacy {@value #NamespaceLegacy} references are upgraded to
     * {@value #Namespace}
     *
     ...
     *
     * @return a normalized {@code statement} where legacy {@value #NamespaceLegacy} references are upgraded to
     * {@value #Namespace}
     *
     ...
     *
     * @return a normalized {@code value} where legacy {@value #NamespaceLegacy} references are upgraded to
     * {@value #Namespace}
     *
     ...
     *
     * @return a normalized {@code resource} where legacy {@value #NamespaceLegacy} references are upgraded to
     * {@value #Namespace}
     *
     * @throws NullPointerException if {@code value} is null
     */
     ...
     *
     * @return a normalized {@code iri} where legacy {@value #NamespaceLegacy} references are upgraded to
     * {@value #Namespace}
     *
