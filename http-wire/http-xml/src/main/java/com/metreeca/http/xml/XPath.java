...
public final class XPath {
     ...
     * resolving them against the {@linkplain Node#getBaseURI() base URI} of the target node, if available; syntactically
     * malformed URIs are returned verbatim
     *
     * @throws NullPointerException if {@code xpath} is null
     */
     ...
     * @param xpath the XPath expression to be evaluated against the target node
     *
     * @return a stream of XPath processors targeting nodes generated by evaluating {@code xpath} against the target node
     *
     * @throws NullPointerException if {@code xpath} is null
     */
     ...
     * @param xpath the XPath expression to be evaluated against the target node
     *
     * @return an optional node containing the value produced by evaluating {@code xpath} against the target node, if one
     * was available; an empty optional, otherwise
     *
     * @throws NullPointerException if {@code xpath} is null
     */
