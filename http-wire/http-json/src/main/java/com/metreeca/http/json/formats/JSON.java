...
package com.metreeca.http.json.formats;
 ...
 */
public final class JSON implements Format<JsonValue> {
     ...
     * @throws FormatException      if {@code reader} contains a malformed document
     */
    public static JsonValue json(final Reader reader) throws FormatException {
