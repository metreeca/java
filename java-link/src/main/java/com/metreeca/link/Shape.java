...
import static com.metreeca.link.shapes.Guard.Mode;
...
public abstract class Shape {
     ...
     *
     * @return a copy of this shape where constraint shapes are retained only inside
     * {@linkplain Guard#convey(Shape...) conveying} {@linkplain #then(Shape...) conditional} shapes
     */
    public Shape convey() {
     ...
     *
     * @return a copy of this shape where constraint shapes are retained only inside
     * {@linkplain Guard#filter(Shape...) filtering} {@linkplain #then(Shape...) conditional} shapes, extended to link
     * matches to the {@code anchor} value
     *
     ...
     *
     * @return a {@linkplain When#when(Shape, Shape) conditional} shape applying this shape as test condition to
     * {@code shapes}
     *
